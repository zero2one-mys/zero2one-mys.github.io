...
export const APPS = [
  ...
  { app: "merge-planet", name: "Merge Game Maker" },
  ...
  { app: "increasing-balls", name: "Increasing Balls" },
  { app: "shp-memo-plus", name: "かいものメモ+" },
  { app: "escape-room-alerts", name: "Escape Room Game New Release Alerts" },
];

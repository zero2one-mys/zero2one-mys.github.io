...
export default function PrivacyPolicy() {
  return (
    <main className="px-6 space-y-4">
      ...
      <p>
        zero2onemys built the app as ad-supported app. This SERVICE is provided
        by zero2onemys at no cost and is intended for use as is.
      </p>
      <p>
      ...
      <p>
        ...
        Terms and Conditions, which are accessible at app unless otherwise

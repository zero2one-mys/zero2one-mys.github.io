...
export default function PrivacyPolicy({ params }: { params: Props }) {
  const { app } = params;
  ...
  return (
    <main className="px-6 space-y-4">
      ...
      <p>
        zero2onemys built the {appName} app as ad-supported app. This SERVICE is
        provided by zero2onemys at no cost and is intended for use as is.
      </p>
      <p>
      ...
      <p>
        ...
        Terms and Conditions, which are accessible at {appName} unless otherwise
      ...
      <p>
        ...
        hesitate to contact me at zero2onemys@gmail.com.
      </p>
      <p>
